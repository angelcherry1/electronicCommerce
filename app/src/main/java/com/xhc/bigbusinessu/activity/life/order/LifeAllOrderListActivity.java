package com.xhc.bigbusinessu.activity.life.order;
...
import com.xhc.bigbusinessu.fragment.life.LifeOrderFragment;
import com.xhc.bigbusinessu.fragment.order.ShopGoodsOrderFragment;

public class LifeAllOrderListActivity extends BaseActivity {


    private static final String[] CHANNELS = new String[]{"预约服务订单", "接收服务订单", "退款单"};
    ...
    protected void setContentView() {
        ...
        setContentView(R.layout.aty_all_life_order);
...
//        }
    ...
    private class MyAdapter extends IndicatorViewPager.IndicatorFragmentPagerAdapter {
        ...
        public Fragment getFragmentForPage(int position) {
            LifeOrderFragment mainFragment = new LifeOrderFragment();
