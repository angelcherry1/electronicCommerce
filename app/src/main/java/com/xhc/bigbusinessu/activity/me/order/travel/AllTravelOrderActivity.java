package com.xhc.bigbusinessu.activity.me.order.travel;
...
import com.xhc.bigbusinessu.fragment.order.TravelOrderFragment;

public class AllTravelOrderActivity extends BaseActivity {
    ...
    protected void setContentView() {
        ...
        setContentView(R.layout.aty_all_travel_order);
    ...
    private class MyAdapter extends IndicatorViewPager.IndicatorFragmentPagerAdapter {
        ...
        public Fragment getFragmentForPage(int position) {
            TravelOrderFragment mainFragment = new TravelOrderFragment();
