...
public class HotelMultipleScreenSortPop extends PopupWindow {
...
//    List<String> rightDataList = new ArrayList<>();
    ...
    public HotelMultipleScreenSortPop(Activity context) {
        super(context);

        View mContent = LayoutInflater.from(context).inflate(R.layout.pop_hotel_multiple_screen_sort, null);
